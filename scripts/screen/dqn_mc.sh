...
# Experiment name
exp_name="stich_dqn_mc_grid_${grid_size}"
...
do
    ...
    do
      ...
      do
        ...
        --exp.name big_reset_mc_boxes_${number_of_boxes}_grid_${grid_size}_ep_len_${episode_length}_filter_${filtering}_bs_64 \
