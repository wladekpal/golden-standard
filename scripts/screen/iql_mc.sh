...
# Experiment name
exp_name="stitch_iql_mc_grid_${grid_size}"
...
do
    ...
    do
      ...
      do
        ...
        --exp.name big_mc_boxes_${number_of_boxes}_grid_${grid_size}_ep_len_${episode_length}_${filtering} \
        ...
        --exp.seed ${seed} \
        --exp.project "gciql_search_mc_vs_td_stitch" \
        --exp.epochs 50 \
        --exp.gif_every 10 \
        --agent.alpha 0.1 \
        --agent.expectile 0.5  \
