...
# Experiment name
exp_name="dqn_lstm_embedding_test"
    ...
    do
        ...
        do
            ...
            CUDA_VISIBLE_DEVICES=$GPU_ID uv run --active src/train.py \
                ...
                --exp.name g${grid_size}_aggregate_b${number_of_boxes}_embed${cell_embed_dim}_nopos_hidden${lstm_hidden_size}_m${number_of_moving_boxes_max}_t${thinking_steps_test} \
                ...
                --agent.no-process-spatial-sequence \
