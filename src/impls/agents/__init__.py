...
from impls.agents.gcbc_cnn import GCBCCNNAgent
...
def create_agent(config: ml_collections.FrozenConfigDict, example_batch: dict, seed: int):
    ...
    elif config.agent_name == "gcbc_cnn":
        agent = GCBCCNNAgent.create(
            seed,
            example_batch['observations'],
            example_batch['actions'],
            config,
    ...
    elif config.agent_name == "gcdqn_transformer":
